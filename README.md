...
The packages in the `lama` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo lama` on `Wed, 11 Feb 2015 14:05:40 -0000`
